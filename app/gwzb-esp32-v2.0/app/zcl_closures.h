...
#ifndef APP_ZCL_CLOSURES_H_
#define APP_ZCL_CLOSURES_H_
...
#define ZCL_DOORLOCK  	1
#define ZCL_WINDOWCOVERING 1
/*********************************************************************
 * CONSTANTS
 */
 ...
 */
extern osState zclClosures_SendDoorLockRequest( uint8 srcEP, uint16 dstAddr, uint8 cmd,
                                                  zclDoorLock_t *pPayload,
                                                  uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockUnlockTimeoutRequest( uint8 srcEP, uint16 dstAddr,
                                                               zclDoorLockUnlockTimeout_t *pPayload,
                                                               uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockGetLogRecordRequest( uint8 srcEP, uint16 dstAddr,
                                                              uint16 logIndex, uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockSetPINCodeRequest( uint8 srcEP, uint16 dstAddr,
                                                            zclDoorLockSetPINCode_t *pPayload,
                                                            uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockUserIDRequest( uint8 srcEP, uint16 dstAddr, uint8 cmd,
                                                        uint16 userID, uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockClearAllCodesRequest( uint8 srcEP, uint16 dstAddr, uint8 cmd,
                                                               uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockSetUserStatusRequest( uint8 srcEP, uint16 dstAddr,
                                                               uint16 userID, uint8 userStatus,
                                                               uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockSetWeekDayScheduleRequest( uint8 srcEP, uint16 dstAddr,
                                                                    uint8 scheduleID, uint16 userID,
                                                                    uint8 daysMask, uint8 startHour,
                                                                    uint8 startMinute, uint8 endHour, uint8 endMinute,
                                                                    uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockScheduleRequest( uint8 srcEP, uint16 dstAddr, uint8 cmd,
                                                          uint8 scheduleID, uint16 userID,
                                                          uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockSetYearDayScheduleRequest( uint8 srcEP, uint16 dstAddr,
                                                                    uint8 scheduleID, uint16 userID,
                                                                    uint32 zigBeeLocalStartTime, uint32 zigBeeLocalEndTime,
                                                                    uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockSetHolidayScheduleRequest( uint8 srcEP, uint16 dstAddr,
                                                                    uint8 holidayScheduleID, uint32 zigBeeLocalStartTime,
                                                                    uint32 zigBeeLocalEndTime, uint8 operatingModeDuringHoliday,
                                                                    uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockHolidayScheduleRequest( uint8 srcEP, uint16 dstAddr, uint8 cmd,
                                                                 uint8 holidayScheduleID,
                                                                 uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockSetUserTypeRequest( uint8 srcEP, uint16 dstAddr,
                                                             uint16 userID, uint8 userType,
                                                             uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockSetRFIDCodeRequest( uint8 srcEP, uint16 dstAddr,
                                                             zclDoorLockSetRFIDCode_t *pPayload,
                                                             uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockStatusResponse( uint8 srcEP, uint16 dstAddr, uint8 cmd,
                                                         uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockGetLogRecordResponse( uint8 srcEP, uint16 dstAddr,
                                                               zclDoorLockGetLogRecordRsp_t *pPayload,
                                                               uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockGetPINCodeResponse( uint8 srcEP, uint16 dstAddr,
                                                             zclDoorLockGetPINCodeRsp_t *pPayload,
                                                             uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockGetUserStatusResponse( uint8 srcEP, uint16 dstAddr,
                                                                uint16 userID, uint8 userStatus,
                                                                uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockGetWeekDayScheduleResponse( uint8 srcEP, uint16 dstAddr,
                                                                     zclDoorLockGetWeekDayScheduleRsp_t *pCmd,
                                                                     uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockGetYearDayScheduleResponse( uint8 srcEP, uint16 dstAddr,
                                                                     zclDoorLockGetYearDayScheduleRsp_t *pCmd,
                                                                     uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockGetHolidayScheduleResponse( uint8 srcEP, uint16 dstAddr,
                                                                     zclDoorLockGetHolidayScheduleRsp_t *pCmd,
                                                                     uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockGetUserTypeResponse( uint8 srcEP, uint16 dstAddr,
                                                              uint16 userID, uint8 userType,
                                                              uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockGetRFIDCodeResponse( uint8 srcEP, uint16 dstAddr,
                                                              zclDoorLockGetRFIDCodeRsp_t *pPayload,
                                                              uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockOperationEventNotification( uint8 srcEP, uint16 dstAddr,
                                                                     zclDoorLockOperationEventNotification_t *pPayload,
                                                                     uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_SendDoorLockProgrammingEventNotification( uint8 srcEP, uint16 dstAddr,
 ...
 * See Function Macros for app-level send functions
 */
extern osState zclClosures_WindowCoveringSimpleReq( uint8 srcEP, uint16 dstAddr,
                                                      uint8 cmd, uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_WindowCoveringSendGoToValueReq( uint8 srcEP, uint16 dstAddr,
                                                             uint8 cmd, uint16 value,
                                                             uint8 disableDefaultRsp, uint8 seqNum );
extern osState zclClosures_WindowCoveringSendGoToPercentageReq( uint8 srcEP, uint16 dstAddr,
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockLockDoor( uint8 srcEP, uint16 dstAddr, zclDoorLock_t *pPayload, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockUnlockDoor( uint8 srcEP, uint16 dstAddr, zclDoorLock_t *pPayload, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockToggleDoor( uint8 srcEP, uint16 dstAddr, zclDoorLock_t *pPayload, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockGetPINCode( uint8 srcEP, uint16 dstAddr, uint16 userID, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearPINCode( uint8 srcEP, uint16 dstAddr, uint16 userID, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearAllPINCodes( uint8 srcEP, uint16 dstAddr, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockGetUserStatus( uint8 srcEP, uint16 dstAddr, uint16 userID, uint8 disableDefaultRsp, uint8 seqNum )
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockGetWeekDaySchedule( uint8 srcEP, uint16 dstAddr, uint8 scheduleID, uint16 userID, uint8 disableDefaultRsp, uint8 seqNum);
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearWeekDaySchedule( uint8 srcEP, uint16 dstAddr, uint8 scheduleID, uint16 userID, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockGetYearDaySchedule( uint8 srcEP, uint16 dstAddr, uint8 scheduleID, uint16 userID, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearYearDaySchedule( uint8 srcEP, uint16 dstAddr, uint8 scheduleID, uint16 userID, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockGetHolidaySchedule( uint8 srcEP, uint16 dstAddr, uint8 holidayScheduleID, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearHolidaySchedule( uint8 srcEP, uint16 dstAddr, uint8 holidayScheduleID, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockGetUserType( uint8 srcEP, uint16 dstAddr, uint16 userID, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockGetRFIDCode( uint8 srcEP, uint16 dstAddr, uint16 userID, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearRFIDCode( uint8 srcEP, uint16 dstAddr, uint16 userID, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearAllRFIDCodes( uint8 srcEP, uint16 dstAddr, uint8 disableDefaultRsp, uint8 seqNum )
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockLockDoorRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum )
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockUnlockDoorRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum )
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockToggleDoorRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockUnlockWithTimeoutRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockSetPINCodeRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearPINCodeRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearAllPINCodesRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockSetUserStatusRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockSetWeekDayScheduleRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearWeekDayScheduleRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockSetYearDayScheduleRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearYearDayScheduleRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockSetHolidayScheduleRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearHolidayScheduleRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockSetUserTypeRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockSetRFIDCodeRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearRFIDCodeRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDoorLockClearAllRFIDCodesRsp( uint8 srcEP, uint16 dstAddr, uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
 */
 ...
 *  Use like:
 *      osState zclClosures_SendUpOpen( uint8 srcEP, uint16 dstAddr, uint8 disableDefaultRsp, uint8 seqNum )
 */
 ...
 *  Use like:
 *      osState zclClosures_SendDownClose( uint8 srcEP, uint16 dstAddr, uint8 disableDefaultRsp, uint8 seqNum )
 */
 ...
 *  Use like:
 *      osState zclClosures_SendStop( uint8 srcEP, uint16 dstAddr, uint8 disableDefaultRsp, uint8 seqNum )
 */
 ...
 *  Use like:
 *      osState zclClosures_SendGoToLiftValue( uint8 srcEP, uint16 dstAddr, uint16 liftValue, uint8 disableDefaultRsp, uint8 seqNum )
 */
 ...
 *  Use like:
 *      osState zclClosures_SendGoToLiftPercentage( uint8 srcEP, uint16 dstAddr, uint8 percentageLiftValue, uint8 disableDefaultRsp, uint8 seqNum )
 */
 ...
 *  Use like:
 *      osState zclClosures_SendGoToTiltValue( uint8 srcEP, uint16 dstAddr, uint16 tiltValue, uint8 disableDefaultRsp, uint8 seqNum )
 */
 ...
 *  Use like:
 *      osState zclClosures_SendGoToTiltPercentage( uint8 srcEP, uint16 dstAddr, uint8 percentageTiltValue, uint8 disableDefaultRsp, uint8 seqNum )
 */
